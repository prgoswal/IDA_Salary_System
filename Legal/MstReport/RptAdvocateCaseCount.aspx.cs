...
public partial class Legal_MstReport_RptAdvocateCaseCount : System.Web.UI.Page
{
    ...
    protected void btnsearch_Click(object sender, EventArgs e)
    {
            if (txtfromdate.Text != "")
            {
                ...
                ht.Add("ReportSearchTitle", "Advocate Name Wise");
            }
            else
            {
        ...
        Session["HT"] = ht;
        Session["Report"] = "RptAdvocateCaseCount";
        Session["ReportName"] = "Advocate Case Count";
