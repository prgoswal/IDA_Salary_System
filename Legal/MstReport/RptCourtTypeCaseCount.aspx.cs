...
public partial class Legal_MstReport_RptCourtTypeCaseCount : System.Web.UI.Page
{
    ...
    protected void btnsearch_Click(object sender, EventArgs e)
    {
        if (txtfromdate.Text != "")
        {
           ...
           // ht.Add("ReportSearchTitle", "Search By From Date . - " + Convert.ToString(txtfromdate.Text));
            ht.Add("ReportSearchTitle", "Court Type Wise");
        }
        else
        {
        ...
        Session["HT"] = ht;
        Session["Report"] = "RptCourtTypeCaseCount";
        Session["ReportName"] = "Court Type Case Count";
