...
public partial class Legal_MstReport_RptCourtPlaceCaseCount : System.Web.UI.Page
{
    ...
    protected void btnsearch_Click(object sender, EventArgs e)
    {
        if (txtfromdate.Text != "")
        {
            ...
            ht.Add("ReportSearchTitle", "Place of Court Wise");
        }
        else
        {
        ...
        Session["HT"] = ht;
        Session["Report"] = "RptCourtPlaceCaseCount";
        Session["ReportName"] = "Court Place Case Count";
