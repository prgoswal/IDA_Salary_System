<%@ Page Title="" Language="C#" MasterPageFile="~/Legal/LegalMaster.master" AutoEventWireup="true" CodeFile="FrmCaseDetailUpdate.aspx.cs" Inherits="FrmCaseDetailUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-xs-12 mrgntp10">
        <div class="panel panel-primary form-horizontal">
            <div class="panel-heading">Case Detail Update</div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtSuitRegNo" CssClass="errorMsg" Display="Dynamic" ValidationGroup="s" ForeColor="Red" SetFocusOnError="true" ErrorMessage="दावा रजिस्टर क्रमांक दर्ज करे"></asp:RequiredFieldValidator>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtSuitRegDate" CssClass="errorMsg-r" Display="Dynamic" ValidationGroup="s" ForeColor="Red" SetFocusOnError="true" ErrorMessage="दावा रजिस्टर दिनांक  दर्ज करे"></asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="reg" runat="server" ForeColor="Red" SetFocusOnError="true" CssClass="errorMsg-r" ControlToValidate="txtSuitRegDate" ValidationExpression="^(((((0[1-9])|(1\d)|(2[0-8]))[/]((0[1-9])|(1[0-2])))|((31[/]((0[13578])|(1[02])))|((29|30)[/]((0[1,3-9])|(1[0-2])))))[/]((20[0-9][0-9]))|(29[/]02[/]20(([02468][048])|([13579][26]))))$" ErrorMessage="Invalid date format." ValidationGroup="s" />
                                ...
                                <div class="col-sm-1">
                                    <div class="form-group">
                                        <label class="col-sm-12 col-xs-12">&nbsp;<i class="Star"> </i></label>
                                        <div class="col-xs-12">
                                            <asp:Button ID="btnCaseSearch" runat="server" ValidationGroup="s" CssClass="btn btn-success form-control" OnClick="btnCaseSearch_Click" Text="Search" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12 col-xs-12">
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ForeColor="Red" SetFocusOnError="true" CssClass="errorMsg-r" ControlToValidate="txtNoticeDate" ValidationExpression="^(((((0[1-9])|(1\d)|(2[0-8]))[/]((0[1-9])|(1[0-2])))|((31[/]((0[13578])|(1[02])))|((29|30)[/]((0[1,3-9])|(1[0-2])))))[/]((20[0-9][0-9]))|(29[/]02[/]20(([02468][048])|([13579][26]))))$" ErrorMessage="Invalid date format." ValidationGroup="a" />
                                ...
                                <div class="col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        <label class="col-sm-12 col-xs-12">न्यायालय / स्थान का नाम</label>
                                        <div class="col-sm-12">
                                            <asp:DropDownList runat="server" CssClass="form-control form-control-xs" ID="ddlCourtPlace"></asp:DropDownList>
                                ...
                                <div class="col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12 col-xs-12">
                                            <asp:TextBox runat="server" MaxLength="60" placeholder="" CssClass="form-control form-control-xs text-uppercase " ID="TextBox5" ReadOnly="true" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <asp:TextBox ID="txtOldCaseNo" runat="server" MaxLength="8" placeholder="केस का नंबर" CssClass="form-control form-control-xs numberonly" />
                                ...
                                <div class="col-sm-2 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txtcaseDetails" ValidationGroup="a" ForeColor="Red" Display="Dynamic" ErrorMessage="प्राथम पेशी दिनांक दर्ज करे "></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-sm-12 ">
                                                    ...
                                                    <asp:GridView ID="GridOIC" runat="server" CssClass="table table-bordered tblhieght " OnRowCommand="GridOIC_RowCommand" AutoGenerateColumns="false">
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataFormatString="{0:dd/MM/yyyy}" DataField="OICLetterDate" HeaderStyle-CssClass="tblhd" HeaderText="दिनांक" />
                                                            <%--<asp:TemplateField DataFormatString="{0:MM/dd/yyyy}" HeaderStyle-CssClass="tblhd" HeaderText="दिनांक">
                                                                <ItemTemplate>
                                                                    <%# Eval("OICLetterDate") %>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>--%>
                                                ...
                                                <div class="col-sm-12 ">
                                                    ...
                                                    <asp:GridView ID="GridAdvo" runat="server" CssClass="table table-bordered tblhieght " OnRowCommand="GridAdvo_RowCommand" AutoGenerateColumns="false">
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataFormatString="{0:dd/MM/yyyy}" DataField="AdvoLetterDate" HeaderStyle-CssClass="tblhd" HeaderText="दिनांक" />
            ...
            <div class="panel-footer">
                <asp:Button ID="btnSave" Text="Save" Visible="false" runat="server" ValidationGroup="a" OnClick="btnSave_Click" CssClass="btn btn-success btnSave" />
                <asp:Button ID="BtnUpdate" Text="Update" runat="server" OnClick="BtnUpdate_Click" ValidationGroup="a" CssClass="btn btn-success btnSave" />
