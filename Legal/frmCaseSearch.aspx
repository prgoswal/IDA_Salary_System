<%@ Page Title="" Language="C#" MasterPageFile="~/Legal/LegalMaster.master" AutoEventWireup="true" CodeFile="frmCaseSearch.aspx.cs" Inherits="frmCaseSearch" %>
                        ...
                        <div class="panel-group acrdn_pnl">
                         ...
                         <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <asp:GridView ID="dgv_ShowwAlldata" runat="server" AutoGenerateColumns="false"  CssClass="table table-responsive table-bordered table-hover" HeaderStyle-BackColor="#006699" HeaderStyle-ForeColor="white">
                                      ...
                                      <ItemTemplate >
                                       <%#Container.DataItemIndex+1 %>
                                            ...
                                            <asp:BoundField DataField="PartyName" HeaderText="Party Name " />
                                             ...
                                             <asp:BoundField DataField="CourtNmH" HeaderText="Court Name " />
                                        </Columns>
