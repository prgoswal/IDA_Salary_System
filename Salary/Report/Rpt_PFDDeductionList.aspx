<%@ Page Title="" Language="C#" MasterPageFile="~/Salary/SalaryMaster.master" AutoEventWireup="true" CodeFile="Rpt_PFDDeductionList.aspx.cs" Inherits="Salary_Report_Rpt_PFDDeductionList" %>
        ...
        <ContentTemplate>
            ...
            <div class="col-xs-12 col-sm-6 col-sm-offset-3 mrgntp10 mt10">
                <div class="panel panel-primary ">
                    <div class="panel-heading" style="text-align: center">PF DEDUCTION LIST</div>
                                ...
                                <div class="col-sm-12">
                                    <div class="brdr_box">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12 col-xs-12 mtb">
                                                <div class="row">
                                                    <label class="col-sm-3 col-xs-12 ">&nbsp;<i class="text-danger"></i></label>
                                                    <div class="col-sm-9">
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <asp:CheckBox Text=" Final PF Statement" ID="ChkPfStatment" runat="server" />
                                                            </div>
