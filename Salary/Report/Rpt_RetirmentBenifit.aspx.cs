...
public partial class Report_Rpt_RetirmentBenifit : System.Web.UI.Page
{
    DataTable dt;
    DataSet ds;
    ...
    protected void btnpreview_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            HT.Add("SearchType", ddLType.SelectedValue);
            ...
            {
                Session["Report"] = "RptRetirementBenefitGratuity";
            }
            else
            {
                Session["Report"] = "RptRetirementBenefit";
            }
            Session["ReportName"] = ddLType.SelectedItem.Text;
