...
public partial class Report_Rpt_SalManualFinalControl : System.Web.UI.Page
{
    DataTable dt;
    DataSet ds;
    ...
    protected void btnpreview_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            HT.Add("VnoTo", txtVoucherTo.Text == "" ? "0" : txtVoucherTo.Text);
            ...
            Session["HT"] = HT;
            Session["Report"] = "RptManualFinalControl";
