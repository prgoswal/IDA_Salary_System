...
public partial class Report_TransLeaveLedger : System.Web.UI.Page
{
    DataTable dt;
    DataSet ds;
    ...
    public void Fill_TypeofLeave()
    {
        ...
        if (dt != null)
        {
            if (dt.Rows.Count > 0)
            {
                ...
                ddlleaveopening.Items.Insert(0, new ListItem(" All ", "0"));
            }
            else
            {
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Session["HT"] = HT;
            Session["Report"] = "RptTransLeaveLedger";
            Session["ReportName"] = ddlleaveopening.SelectedItem.Text;
            Response.Redirect("ReportViewer.aspx?index=28");
        }
    }
