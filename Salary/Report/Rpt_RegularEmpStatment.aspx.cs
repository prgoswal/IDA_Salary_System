...
public partial class Salary_Report_Rpt_RegularEmpStatment : System.Web.UI.Page
{
    DataTable dt;
    DataSet ds;
        ...
        if (ds.Tables.Count > 0)
        {
            if (ds.Tables.Count > 2)
            {
                if (ds.Tables[2].Rows.Count > 0)
                {
                    ...
                    ddlfinancialyear.DataValueField = "FyrId";
    ...
    protected void btnpreview_Click1(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            HT.Add("Year", ddlfinancialyear.SelectedValue);
            Session["HT"] = HT;
            Session["Report"] = "RegularEmp";
