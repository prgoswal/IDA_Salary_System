...
public partial class Report_Rpt_NewLoanControl : System.Web.UI.Page
{
    DataTable dt;
    DataSet ds;
    ...
    bool btnPreviewValidation()
    {
        ...
        if (ddlReprtType.SelectedItem.Value == "0")
        {
            ddlReprtType.Focus();
            ShowMessage(" Please Select Report Type", false);
            return false;
        }
    ...
    protected void btnpreview_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            HT.Add("BnkCd", 0);
            HT.Add("BrCd", 0);
            HT.Add("LoanCd", ddlLoanopening.SelectedValue);
            HT.Add("FIXPAY", 0);
            ...
            if (ddlReprtType.SelectedValue == "2")
            {

                if (ddlBankForamt.SelectedValue == "1")
                {
            ...
            Response.Redirect("ReportViewer.aspx?index=35");
        }
    }
    ...
    protected void ddlReprtType_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlReprtType.SelectedValue != "0")
        {
