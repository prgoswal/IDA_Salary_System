<%@ Page Title="" Language="C#" MasterPageFile="~/Salary/SalaryMaster.master" AutoEventWireup="true" CodeFile="ReportViewer.aspx.cs" Inherits="Report_Frm_ReportViewer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="mrgntp10" style="width: 100%; margin-left: auto; margin-right: auto; max-width: 1100px; margin-top: 5px;">
        <div class="panel panel-primary">
            <div class="panel-heading" id="lblHeading" style='text-transform: uppercase; padding: 5px' runat="server"></div>
                        ...
                        <div class="panel panel-default" style="margin-bottom: -2px; border: 0; padding: 2px">
                            ...
                            <div class="panel-table table-black">
                                <asp:Panel runat="server" ID="pnlPrintDraftPatta" Visible="false">
                                    <rsweb:ReportViewer Height="452px" ShowParameterPrompts="false" Width="100%" ID="ReportViewer1" runat="server"></rsweb:ReportViewer>
                                </asp:Panel>
                            </div>
            ...
            <div class="panel-footer text-center" style="padding: 5px">
                ...
                <asp:Button Text="&#xf0a8; Back" ID="btnBack" runat="server" OnClick="btnBack_Click" CssClass="font-awesome-font btn btn-danger fa fa-arrow-left" aria-hidden="true" />
            </div>
        </div>
    </div>
</asp:Content>
