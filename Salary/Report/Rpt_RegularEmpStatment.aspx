<%@ Page Title="" Language="C#" MasterPageFile="~/Salary/SalaryMaster.master" AutoEventWireup="true" CodeFile="Rpt_RegularEmpStatment.aspx.cs" Inherits="Salary_Report_Rpt_RegularEmpStatment" %>
        ...
        <ContentTemplate>
            ...
            <div class="col-xs-12 col-sm-6 col-sm-offset-3 mrgntp10 mt10">
                <div class="panel panel-primary ">
                    <div class="panel-heading" style="text-align: center">REGULAR EMPLOYEE STATMENT</div>
                                ...
                                <div class="col-sm-12">
                                    <div class="brdr_box">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    <label class="col-xs-3">Financial Year<i class="text-danger"> *</i></label><div class="col-sm-4">
                                                        <asp:DropDownList runat="server" CssClass="form-control form-control-xs col-sm-9" ID="ddlfinancialyear"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 text-left">
                                <asp:LinkButton CssClass="btn btn-info" ID="btnpreview" OnClick="btnpreview_Click1" runat="server"><i class="fa r  fa-eye"></i> Preview</asp:LinkButton>
