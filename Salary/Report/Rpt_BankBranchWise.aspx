<%@ Page Title="" Language="C#" MasterPageFile="~/Salary/SalaryMaster.master" AutoEventWireup="true" CodeFile="Rpt_BankBranchWise.aspx.cs" Inherits="Report_Rpt_BankBranchWise" %>
        ...
        <ContentTemplate>
            ...
            <div class="mrgntp10 mt10 mlr-auto" style="max-width: 770px">
                <div class="panel panel-primary ">
                    <div class="panel-heading" style="text-align: center">BANK BRANCH WISE REPORT </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="row rdo">
                                                            <div class="radio-5-grid">
                                                                <asp:RadioButtonList ID="rbBranchwiseDetails" runat="server"  BackColor="White" BorderStyle="None" CssClass="LBLPK" Font-Bold="True" Height="16px" RepeatDirection="Horizontal" Width="450px">
                                                                    <asp:ListItem Selected="True" Value="0">Bank / Branch Wise </asp:ListItem>
                                                                    <asp:ListItem Value="1">Bank / Branch Wise Summary</asp:ListItem>
                                                                </asp:RadioButtonList>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    <label class="col-xs-3">Bank Name<i class="text-danger"> *</i></label><div class="col-sm-9">
                                                        <asp:DropDownList runat="server" CssClass="form-control form-control-xs col-sm-9" ID="ddlBank" OnSelectedIndexChanged="ddlBank_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
