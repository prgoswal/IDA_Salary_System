<%@ Page Title="" Language="C#" MasterPageFile="~/Salary/SalaryMaster.master" AutoEventWireup="true" CodeFile="Rpt_LeaveOpening.aspx.cs" Inherits="Salary_Report_Rpt_LeaveOpening" %>
    ...
    <script type="text/javascript">
        function Validation() {
            ...
            if ($('#<%=ddlSelectType.ClientID%>').val() == '3') {
              ...
              if ($('#<%=ddlleaveopening.ClientID%>').val() == '0') {
                $('#<%=lblMsg.ClientID%>').addClass('alertMsg failed');
                $('#<%=lblMsg.ClientID%>').html('Please Select Type Of Leave');
                $('#<%=lblMsg.ClientID%>').show();
                $('#<%=ddlleaveopening.ClientID%>').css('border-color', 'red');
                $('#<%=ddlleaveopening.ClientID%>').focus();
                return false;
            }
            else {
                $('#<%=ddlleaveopening.ClientID%>').css('border-color', 'lightgray');
            }
            return true;
        }
    </script>
        ...
        <ContentTemplate>
            <div class="col-xs-12 col-sm-6 col-sm-offset-3 mrgntp10 mt10">
                <div class="panel panel-primary">
                    <div class="panel-heading">Leave Opening Report</div>
                                                ...
                                                <div class="col-sm-12 col-xs-12 mtb">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <asp:TextBox runat="server" ID="txtFromEmp" MaxLength="10" OnTextChanged="txtFromEmp_TextChanged" CssClass="form-control form-control-xs numberonly" placeholder="From" />
                                                                </div>
                                                                <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 mtb">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <asp:DropDownList runat="server" ID="ddlleaveopening" CssClass="form-control form-control-xs">
