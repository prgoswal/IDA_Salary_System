...
public partial class Report_Rpt_EmpMasterRetirmentList : System.Web.UI.Page
{
    DataTable dt;
    DataSet ds;
    ...
    protected void btnpreview_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            HT.Add("RetirmentInd", 1);
            Session["HT"] = HT;
            Session["Report"] = "RptEmpRetirmentList";
            Session["ReportName"] = ddlSelectType.SelectedItem.Text;
            Response.Redirect("ReportViewer.aspx?index=36");
        }
    }
