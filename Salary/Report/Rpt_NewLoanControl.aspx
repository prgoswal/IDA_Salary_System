<%@ Page Title="" Language="C#" MasterPageFile="~/Salary/SalaryMaster.master" AutoEventWireup="true" CodeFile="Rpt_NewLoanControl.aspx.cs" Inherits="Report_Rpt_NewLoanControl" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function Validation() {
            ...
            if ($('#<%=ddlReprtType.ClientID%>').val() == '0') {
                $('#<%=lblMsg.ClientID%>').addClass('alertMsg failed');
                 $('#<%=lblMsg.ClientID%>').html('Please Select Report Type');
                 $('#<%=lblMsg.ClientID%>').show();
                 $('#<%=ddlReprtType.ClientID%>').css('border-color', 'red');
                 $('#<%=ddlReprtType.ClientID%>').focus();
                 return false;
             }
             return true;
        }
        ...
        <ContentTemplate>
            ...
            <div class="mrgntp10 mt10 mlr-auto" style="max-width: 770px">
                <div class="panel panel-primary ">
                    <div class="panel-heading" style="text-align: center">New Loan Control</div>
                                ...
                                <div class="col-sm-12">
                                    <div class="brdr_box">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    <label class="col-xs-3">Report Type<i class="text-danger"> *</i></label><div class="col-sm-9">
                                                        <%--  <asp:DropDownList runat="server" CssClass="form-control form-control-xs col-sm-9" ID="ddlReprtType">
                                                            <asp:ListItem Value="0" Text="-- Select Report Type -- " />
                                                            <asp:ListItem Value="1" Text="Bank / Branch Reprot" />
                                                            <asp:ListItem Value="2" Text="Bank / Branch Summary" />
                                                        </asp:DropDownList>--%>

                                                        <asp:DropDownList runat="server" CssClass="form-control form-control-xs col-sm-9" ID="ddlReprtType" OnSelectedIndexChanged="ddlReprtType_SelectedIndexChanged" AutoPostBack="true">
                                                            <asp:ListItem Value="0" Text="-- Select Report Type -- " />
                                                            <asp:ListItem Value="1" Text="Check List Reprot" />
                                                            <asp:ListItem Value="2" Text="Bank / Branch Report" />
                                                        </asp:DropDownList>
                                        ...
                                        <asp:Panel runat="server" ID="pnlBankList" Visible="false">

                                            <div class="row">
                                                <div class="col-sm-12 mtb">
                                                    <div class="form-group">
                                                        <label class="col-sm-3 col-xs-12">Type&nbsp;Of&nbsp;Format&nbsp;<i class="Star">*</i></label>
                                                        <div class="col-sm-9">
                                                            <asp:DropDownList runat="server" ID="ddlBankForamt" CssClass="form-control form-control-xs">
                                                                <asp:ListItem Value="1" Text="Bank / Branch Reprot" />
                                                                <asp:ListItem Value="2" Text="Bank / Branch Summary" />
                                                            </asp:DropDownList>
                                                        </div>
                                        ...
                                        <asp:Panel runat="server" ID="pnlCheckList" Visible="false">
                                            <div class="row">
                                                <div class="col-sm-12 mtb">
                                                    <div class="form-group">
