...
public partial class Report_Rpt_LicPolicyChecklist : System.Web.UI.Page
{
    DataTable dt;
    DataSet ds;
    ...
    protected void btnpreview_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //}
            if (RadioButtonList2.SelectedItem.Value == "0")
            {
                Session["indication"] = "1";
            }
            else if (RadioButtonList2.SelectedItem.Value == "1")
            {
                Session["indication"] = "2";
            }
            else if (RadioButtonList2.SelectedItem.Value == "2")
            {
                Session["indication"] = "4";
            }
            else
            {
                Session["indication"] = "3";
            }
            //Hashtable HT = new Hashtable();
            //HT.Add("MonthDesc", Session["MonthDesc"].ToString());
            //HT.Add("indication", Session["indication"].ToString());
            ...
            Session["HT"] = HT;
            Session["Report"] = "RptLICErrorChklist";
            Session["ReportName"] = ddlSelectType.SelectedItem.Text;
