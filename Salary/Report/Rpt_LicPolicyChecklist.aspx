<%@ Page Title="" Language="C#" MasterPageFile="~/Salary/SalaryMaster.master" AutoEventWireup="true" CodeFile="Rpt_LicPolicyChecklist.aspx.cs" Inherits="Report_Rpt_LicPolicyChecklist" %>
        ...
        <ContentTemplate>
            ...
            <div class="mrgntp10 mt10 mlr-auto" style="max-width: 770px">
                <div class="panel panel-primary ">
                    <div class="panel-heading" style="text-align: center">LIC POLICY CHECK LIST</div>
                                            ...
                                            <div class="col-sm-12 col-xs-12 mtb" style="text-align: center">
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <div class="row rdo">
                                                            <div class="radio-5-grid">
                                                                <asp:RadioButtonList ID="RadioButtonList2" runat="server" BackColor="White" BorderStyle="None" CssClass="LBLPK" Font-Bold="True" Height="16px" RepeatDirection="Horizontal" Width="450px">
                                                                    <asp:ListItem Selected="True" Value="0">Error List</asp:ListItem>
                                                                    <asp:ListItem Value="1">Final List</asp:ListItem>
                                                                    <asp:ListItem Value="2">Stop Case Reports</asp:ListItem>
                                                                </asp:RadioButtonList>
                                                            </div>
                                                        </div>
                                                    </div>
