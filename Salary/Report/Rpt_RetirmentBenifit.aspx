<%@ Page Title="" Language="C#" MasterPageFile="~/Salary/SalaryMaster.master" AutoEventWireup="true" CodeFile="Rpt_RetirmentBenifit.aspx.cs" Inherits="Report_Rpt_RetirmentBenifit" %>
        ...
        function EmployeeFun() {
          ...
          function Validation() {
            ...
            if ($('#<%=ddLType.ClientID%>').val() == '0') {
                ...
                $('#<%=lblMsg.ClientID%>').html('Please Select Type');
                $('#<%=lblMsg.ClientID%>').show();
                $('#<%=ddLType.ClientID%>').css('border-color', 'red');
                $('#<%=ddLType.ClientID%>').focus();
                return false;
            }
            else {
                $('#<%=ddLType.ClientID%>').css('border-color', 'lightgray');
                $('#<%=ddLType.ClientID%>').css('border-color', 'lightgray');
            }
        }
    </script>
                                        ...
                                        <%--  <div class="row" style="text-align:left">
                                            <div class="col-sm-12 mtb">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <asp:DropDownList runat="server" ID="ddLType" CssClass="form-control form-control-xs">
                                        ...
                                        <div class="row" style="text-align: center; display: none">
                                            <div class="col-sm-12 mtb">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <asp:TextBox runat="server" ID="txtEmployeeNo" MaxLength="10" placeholder="Employee No." CssClass="form-control form-control-xs numberonly" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
