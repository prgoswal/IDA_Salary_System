<%@ Page Title="" Language="C#" MasterPageFile="~/Salary/SalaryMaster.master" AutoEventWireup="true" CodeFile="Rpt_SalManualFinalControl.aspx.cs" Inherits="Report_Rpt_SalManualFinalControl" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function Validation() {
            ...
            if ($('#<%=txtVoucherFrom.ClientID%>').val() != "") {
                if ($('#<%=txtVoucherFrom.ClientID%>').val() == "" || $('#<%=txtVoucherTo.ClientID%>').val() == "") {
                     $('#<%=lblMsg.ClientID%>').addClass('alertMsg failed');
                    $('#<%=lblMsg.ClientID%>').html('Please Enter Voucher To ');
                    $('#<%=lblMsg.ClientID%>').show();
                    $('#<%=txtVoucherTo.ClientID%>').css('border-color', 'red');
                    $('#<%=txtVoucherTo.ClientID%>').focus();
                    $('#<%=txtVoucherTo.ClientID%>').css('border-color', 'red');
                    return false;
                }
                return true;
                ...
                $('#<%=txtVoucherTo.ClientID%>').css('border-color', 'lightgray');
                 $('#<%=txtVoucherTo.ClientID%>').css('border-color', 'lightgray');
             }

             if ($('#<%=txtbillno.ClientID%>').val() != "") {
                if ($('#<%=txtbillno.ClientID%>').val() == "" || $('#<%=txtdate.ClientID%>').val() == "") {
                    $('#<%=lblMsg.ClientID%>').addClass('alertMsg failed');
                    $('#<%=lblMsg.ClientID%>').html('Please Enter Bill Date ');
                    $('#<%=lblMsg.ClientID%>').show();
                    $('#<%=txtdate.ClientID%>').css('border-color', 'red');
                ...
                $('#<%=txtdate.ClientID%>').css('border-color', 'lightgray');
                $('#<%=txtdate.ClientID%>').css('border-color', 'lightgray');
            }
        }
    </script>
        ...
        <ContentTemplate>
            ...
            <div class="mrgntp10 mt10 mlr-auto" style="max-width: 770px">
                <div class="panel panel-primary ">
                    <div class="panel-heading" style="text-align: center">SUPPLEMENTARY PATRAK FINAL CONTROL</div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="brdr_box">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="row rdo">
                                                            <div class="radio-5-grid">
                                                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged" AutoPostBack="True" BackColor="White" BorderStyle="None" CssClass="LBLPK" Font-Bold="True" Height="16px" RepeatDirection="Horizontal" Width="450px">
                                        ...
                                        <asp:Panel runat="server" ID="PnlVoucher">
                                            <div class="form-group">
                                                <div class="col-sm-12 col-xs-12 mtb">
                                                    <div class="row">
                                                        <label class="col-sm-3 col-xs-12 ">Voucher From/To </label>
                                                        <div class="col-sm-9">
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <asp:TextBox runat="server" ID="txtVoucherFrom" MaxLength="10" CssClass="form-control form-control-xs numberonly" placeholder="From" />
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <asp:TextBox runat="server" ID="txtVoucherTo" MaxLength="10" CssClass="form-control form-control-xs numberonly" placeholder="To" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <asp:Panel runat="server" ID="PnlBillNoDate">
                                            <div class="form-group">
                                                <div class="col-sm-12 col-xs-12 mtb">
                                                    <div class="row">
                                                        <label class="col-sm-3 col-xs-12 ">Bill No/Date </label>
                                                        <div class="col-sm-9">
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <asp:TextBox runat="server" ID="txtbillno" MaxLength="10" CssClass="form-control form-control-xs numberonly" placeholder="Bill No" />
                                                                </div>
                                                                <div class="col-sm-6 date-picker-icon">
                                                                    <asp:TextBox runat="server" ID="txtdate" MaxLength="10" CssClass="datepicker form-control form-control-xs date-picker-icon" placeholder="DD/MM/YYYY" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
