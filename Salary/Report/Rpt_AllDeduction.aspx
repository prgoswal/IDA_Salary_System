<%@ Page Title="" Language="C#" MasterPageFile="~/Salary/SalaryMaster.master" AutoEventWireup="true" CodeFile="Rpt_AllDeduction.aspx.cs" Inherits="Report_Rpt_Rpt_AllDeduction" %>
        ...
        <ContentTemplate>
            ...
            <div class="mrgntp10 mt10 mlr-auto" style="max-width: 770px">
                <div class="panel panel-primary ">
                    <div class="panel-heading" style="text-align: center">Deduction Statement</div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 text-left">
                                <asp:LinkButton CssClass="btn btn-warning" ID="btnpreview" OnClientClick="return Validation()" OnClick="btnpreview_Click" runat="server"><i class="fa r  fa-eye"></i> Preview</asp:LinkButton>
