<%@ Page Title="" Language="C#" MasterPageFile="~/Salary/SalaryMaster.master" AutoEventWireup="true" CodeFile="Rpt_SalaryrRgistation.aspx.cs" Inherits="Report_Rpt_SalaryrRgistation" %>
        ...
        <ContentTemplate>
            ...
            <div class="mrgntp10 mt10 mlr-auto" style="max-width: 770px">
                <div class="panel panel-primary ">
                    <div class="panel-heading" style="text-align: center">SALARY REGISTER</div>
                                                ...
                                                <div class="col-sm-12 col-xs-12 mtb">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <asp:CheckBox Text="Single Line Register" ID="chkSingleLineRegister" runat="server" />
                                                                </div>
                                                                <div class="col-sm-6">
