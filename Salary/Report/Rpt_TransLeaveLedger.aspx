<%@ Page Title="" Language="C#" MasterPageFile="~/Salary/SalaryMaster.master" AutoEventWireup="true" CodeFile="Rpt_TransLeaveLedger.aspx.cs" Inherits="Report_TransLeaveLedger" %>
        ...
        <ContentTemplate>
            <div class="col-xs-12 col-sm-6 col-sm-offset-3 mrgntp10 mt10">
                <div class="panel panel-primary">
                    <div class="panel-heading">LEAVE LEDGER</div>
                                    ...
                                    <div class="brdr_box">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 mtb">
                                                <div class="form-group">
                                                    <label class="col-sm-3 col-xs-12">Type&nbsp;of&nbsp;Leave&nbsp;<i class="text-danger">*</i></label>
                                                    <div class="col-sm-9">
