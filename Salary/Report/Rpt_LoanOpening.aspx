<%@ Page Title="" Language="C#" MasterPageFile="~/Salary/SalaryMaster.master" AutoEventWireup="true" CodeFile="Rpt_LoanOpening.aspx.cs" Inherits="Salary_Report_Rpt_LoanOpening" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Validation() {
            if ($('#<%=ddlEmpType.ClientID%>').val() == '0') {
                $('#<%=lblMsg.ClientID%>').addClass('alertMsg failed');
                $('#<%=lblMsg.ClientID%>').html('Please Select Employee Type');
                $('#<%=lblMsg.ClientID%>').show();
                $('#<%=ddlEmpType.ClientID%>').css('border-color', 'red');
                $('#<%=ddlEmpType.ClientID%>').focus();
                return false;
            }
            else {
            ...
            if ($('#<%=ddlSelectType.ClientID%>').val() == '0') {
             ...
             if ($('#<%=ddlLoanopening.ClientID%>').val() == '0') {
                $('#<%=lblMsg.ClientID%>').addClass('alertMsg failed');
                  $('#<%=lblMsg.ClientID%>').html('Please Select Type Of Leave');
                  $('#<%=lblMsg.ClientID%>').show();
                  $('#<%=ddlLoanopening.ClientID%>').css('border-color', 'red');
                  $('#<%=ddlLoanopening.ClientID%>').focus();
                  return false;
              }
              else {
                  $('#<%=ddlLoanopening.ClientID%>').css('border-color', 'lightgray');
              }
              return true;
          }
    </script>
        ...
        <ContentTemplate>
            <div class="col-xs-12 col-sm-6 col-sm-offset-3 mrgntp10 mt10">
                <div class="panel panel-primary">
                    <div class="panel-heading">Loan Opening Report</div>
                                    ...
                                    <div class="brdr_box">
                                                ...
                                                <div class="col-sm-12 col-xs-12 mtb">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <asp:TextBox runat="server" ID="txtFromLot" AutoPostBack="true" MaxLength="10" CssClass="form-control form-control-xs numberonly" placeholder="From" />
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <asp:TextBox runat="server" ID="txtToLot" MaxLength="10" AutoPostBack="true" CssClass="form-control form-control-xs numberonly" placeholder="To" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-12 col-xs-12 mtb">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <asp:TextBox runat="server" ID="txtFromEmp" MaxLength="10" OnTextChanged="txtFromEmp_TextChanged" onchange="return EmployeeFun();" CssClass="form-control form-control-xs numberonly" placeholder="From" />
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <asp:TextBox runat="server" ID="txtToEmp" MaxLength="10" OnTextChanged="txtToEmp_TextChanged" CssClass="form-control form-control-xs numberonly" placeholder="To" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 mtb">
                                                <div class="form-group">
                                                    <label class="col-sm-3 col-xs-12">Type Of Loan<i class="Star">*</i></label>
                                                    <div class="col-sm-9">
                                                        <asp:DropDownList runat="server" ID="ddlLoanopening" CssClass="form-control form-control-xs">
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 text-center">
                                <asp:LinkButton CssClass="btn btn-info" ID="btnShow" OnClientClick="return Validation()" OnClick="btnShow_Click" runat="server"><i class="fa r fa-eye"></i> Preview</asp:LinkButton>
