...
public partial class Salary_Report_Rpt_GlCodewishDetails : System.Web.UI.Page
{
    DataTable dt;
    DataSet ds;
    ...
    public void FillddlGlCode()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            ddlGlCode.DataBind();
            ddlGlCode.Items.Insert(0, new ListItem("ALL", "0"));
        }
    }
    ...
    protected void btnpreview_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            HT.Add("GlCode", ddlGlCode.SelectedValue);

            Session["HT"] = HT;
            Session["Report"] = "RptGlCodeWise";
            Session["ReportName"] = ddlSelectType.SelectedItem.Text;
            Response.Redirect("ReportViewer.aspx?index=40");
